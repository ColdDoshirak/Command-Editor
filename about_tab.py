...
class UpdateChecker:
    ...
    def __init__(self, parent=None, github_repo="colddoshirak/Command-Editor"):
        self.parent = parent
        self.github_repo = github_repo
        self.current_version = "V1.1.5b"  # Default version, will be updated from about tab
...
class AboutTab(QWidget):
    def __init__(self, parent=None):
        ...
        self.parent = parent
        self.current_version = "V1.1.5b"  # Store current version
    ...
    def create_version_tab(self):
        ...
        <p><b>Release Date:</b> 2025-11-27</p>
